...
let IdsIcon = class IdsIcon extends s {
    constructor() {
        super(...arguments);
...
IdsIcon.styles = iconStyles;
__decorate([
    n()
], IdsIcon.prototype, "icon", void 0);
__decorate([
    n()
], IdsIcon.prototype, "size", void 0);
IdsIcon = __decorate([
    e$1(CUSTOM_TAG$1)
], IdsIcon);
...
IdsIconSheet.styles = iconStyles;
__decorate([
    n()
], IdsIconSheet.prototype, "icon", void 0);
__decorate([
    n()
], IdsIconSheet.prototype, "size", void 0);
IdsIconSheet = __decorate([
    e$1(CUSTOM_TAG)
], IdsIconSheet);

export { IconSize, IdsIcon, IdsIconSheet };
